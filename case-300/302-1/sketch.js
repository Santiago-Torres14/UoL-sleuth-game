...
Officer: 1061178
CaseNum: 302-0-34332179-1061178

The Slippery Minsky brothers are notorious cat burglars. 
I’ve been trying to catch them for years but they are masters 
of escape, hence their nickname. I’ve had a tip off that 
Sergey Minsky is breaking into the Gates Bank tonight. 
...
function draw()
{
    ...
    // this makes the animation weird
	//if(endX !== undefined){
	//	if (abs(endX - x) < 30)
	//	{
	//		x = endX;
